...
class ProductSerializer(serializers.ModelSerializer):
    ...
    category_id = serializers.UUIDField(
        write_only=True,
        error_messages={"invalid": "category_id must be a valid UUID"},
    )
    ...
    def to_representation(self, instance):
        ...
        data["seller_id"] = str(instance.seller_id)
        if instance.blocking_reason_id:
            data["blocking_reason_id"] = str(instance.blocking_reason_id)
        else:
            data["blocking_reason_id"] = None
        return data
